    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <a href="{{route('panel.voucher.create')}}" class="btn btn-primary"><i class="fas fa-plus text-white ml-0"></i> Create</a>        
            </div>
            <div class="card-body">
    ...
    <script>
        function datatable() {
            $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('panel.voucher.data') }}" + '?_token=' + '{{ csrf_token() }}',
                columns: [
                    ...
                    {data: 'amount', name: 'amountr', class:"align-middle"},
