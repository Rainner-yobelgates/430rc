...
<div class="row">
    <div class="col-12">
        <div class="card">
            <form action="{{route('panel.workout.update')}}" method="post" enctype="multipart/form-data">
            @method('patch')
            @csrf
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            ...
                            <div class="form-group mb-2">
                                <textarea name="{{$day}}{{$i}}" class="summernote">{{ old($day . $i, $getWorkout[$i-1]->description[$index] ?? '-') }}</textarea>
                                @error($day . $i)
